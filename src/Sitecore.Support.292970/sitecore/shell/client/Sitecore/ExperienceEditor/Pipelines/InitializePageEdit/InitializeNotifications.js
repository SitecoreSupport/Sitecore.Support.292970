    ...
    function (Sitecore, ExperienceEditor, DOMHelper) {
        return {
            ...
            handleNotifications: function (notification) {
                //Fix for bug #292970
                var app = typeof (context) !== "undefined" && context.app ? context.app : ExperienceEditor.RibbonApp.getApp();
                var notificationElement = app.showNotification(notification.type, notification.text, true);
                //End of fix
